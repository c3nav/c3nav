...
urlpatterns = [
    ...
    path('location_tags/<int:pk>/', list_objects, name='editor.location_tags.list'),
...
urlpatterns.extend(add_editor_urls('LocationTag', explicit_edit=True))
urlpatterns.extend(add_editor_urls('ObstacleGroup'))
urlpatterns.extend(add_editor_urls('DynamicLocationTagTarget'))
