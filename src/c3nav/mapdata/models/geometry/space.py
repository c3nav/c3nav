...
class Area(CachedEffectiveGeometryMixin, SpaceGeometryMixin, LocationTagTargetMixin,
...
class POI(SpaceGeometryMixin, LocationTagTargetMixin, AccessRestrictionMixin, models.Model):
    """
    A point of interest
    """
