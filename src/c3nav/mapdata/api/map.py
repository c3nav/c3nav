...
@api_etag(cache_job_types=("mapdata.recalculate_effective_icon", ))  # todo: finer job_types
...
@api_etag(base_mapdata=True, cache_job_types=("mapdata.recalculate_effective_icon", ))  # todo: finer job_types
